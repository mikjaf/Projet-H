		...
		<div class="eventForm">
			...
			<form id="workshopForm" action="event/createWorkshop" method="post" style="background-color: white">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="ex : Création de tifo" id="title" name="title" required/>
				</div>
				...
				<div class="form-group">
					...
					<textarea type="text" class="form-control" placeholder="ex : Venez nous aider à créer le tifo pour le prochain match." id="description" name="description" rows="3" required></textarea>
				</div>
